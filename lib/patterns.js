var _ = require("lodash"),
    patterns = {
        ...
        banned:       /^(\[(\w+): )?Banned player (\w+)(\])?$/,
        unbanned:     /^(\[(\w+): )?Unbanned player (\w+)(\])?$/,
        opped:        /^(\[(\w+): )?Opped (\w+)(\])?$/,
        deopped:      /^(\[(\w+): )?De-opped (\w+)(\])?$/
    };
...
exports.banned = function (game, meta) {
    var match = meta.text.match(patterns.banned);
...
exports.unbanned = function (game, meta) {
    var match = meta.text.match(patterns.unbanned);
...
exports.opped = function (game, meta) {
    var match = meta.text.match(patterns.opped);
...
exports.deopped = function (game, meta) {
    var match = meta.text.match(patterns.deopped);
